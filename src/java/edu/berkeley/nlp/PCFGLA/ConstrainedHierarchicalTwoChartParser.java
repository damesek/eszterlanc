	...
	void doInsideScores(Tree<StateSet> tree, boolean noSmoothing,
		...
		if (tree.isPreTerminal()) {
			...
			case 1:
				...
				HierarchicalAdaptiveUnaryRule urule = (HierarchicalAdaptiveUnaryRule) getGrammar()
			...
			case 2:
				...
				HierarchicalAdaptiveBinaryRule brule = (HierarchicalAdaptiveBinaryRule) getGrammar()
